        ...
        <div id="layout">
            <main class="my-0 mx-auto min-h-full max-w-screen-sm">
                <div class="my-0 mx-auto min-h-screen max-w-480 overflow-x-hidden bg-white pb-[66px]">
                    ...
                    <div class="py-4">
                        <h2 class="px-4 text-base font-semibold text-center">Activity</h2>
                        <div class="relative w-full max-w-2xl">
                            ...
                            <div class="slider overflow-x-auto scroll-smooth pb-4 flex space-x-4 px-4 scroll-pl-15">
                                <div class="flex-shrink-0 w-56 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md ">001</div>
                                <div class="flex-shrink-0 w-56 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md ">002</div>
                                <div class="flex-shrink-0 w-56 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md ">003</div>
                                <div class="flex-shrink-0 w-56 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md ">004</div>
                                <div class="flex-shrink-0 w-56 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md ">005</div>
                                <div class="flex-shrink-0 w-56 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md ">006</div>
                            </div>
                        </div>
                        <script>
                    ...
                    <div class="p-4">
                        ...
                        <div class="relative w-full max-w-2xl bg-slate-200">
                            <div class="overflow-y-auto scroll-smooth grid grid-cols-1 gap-y-9 h-[350px] overscroll-y-auto pt-6">
                                <div class="w-90 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md">001</div>
                                <div class="w-90 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md">002</div>
                                <div class="w-90 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md">003</div>
                                <div class="w-90 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md">004</div>
                                <div class="w-90 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md">005</div>
                                <div class="w-90 h-56 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md">006</div>
                            </div>
                        </div>
                        <!-- <script>
                            ...
                            const slider = document.getElementById('slider');
                                ...
                                const sliderContent = {
                                    food: ['001', '002', '003'],
                                    education: ['004', '005', '006'],
                                    disaster: ['007', '008', '009'],
                                    health: ['010', '011', '012']
                                };
                                ...
                                function updateSlider(categoryType) {
                                    ...
                                    sliderContent[categoryType].forEach(item => {
                                        ...
                                        slide.className = 'flex-shrink-0 w-56 h-56 mt-6 bg-white rounded-lg shadow-sm flex items-center justify-center hover:shadow-md';
                                        slide.textContent = item;
                                        slider.appendChild(slide);
                                    });
                                }

                                // Initialize slider with default category
                                updateSlider('food');
                            });
                        </script> -->
                    </div>
                    ...
                    <div class="px-4 pt-6">
                        ...
                        <a href="" class="text-onyx">Tentang kita</a>
                        |
