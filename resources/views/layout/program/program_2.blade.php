        ...
        <div class="my-0 mx-auto min-h-screen max-w-480 overflow-x-hidden bg-white pb-[66px]">
            ...
            <section class="bg-cover bg-center text-white" style="background-image: url('https://kitabisa.com/_next/image?url=https%3A%2F%2Fimgix.kitabisa.com%2Fabcde12345.jpg%3Fauto%3Dformat%26fm%3Dpjpg%26ch%3DWidth%2CDPR%2CSave-Data%2CViewport-Width&w=640&q=75');">
                <div class="bg-black bg-opacity-60 py-10">
                    <div class="container mx-auto px-4">
                        <h1 class="text-3xl font-bold">Donasi Pembangunan Masjid</h1>
                        <p class="text-lg">Mari kita membantu pembangunan Masjid dengan cara berdonasi</p>
                    </div>
                </div>
            </section>
            ...
            <div class="bg-white shadow-lg rounded-lg max-w-4xl mx-auto my-8">
                <div class="p-4">
                    ...
                    <div class="mt-4">
                        <h3 class="text-2xl font-semibold">Pembangunan Masjid</h3>
                        <p class="text-red-600 text-3xl font-bold mt-2">Rp50.000.000</p>
            ...
            <div class="bg-white shadow-lg rounded-lg max-w-4xl mx-auto mb-8 p-4">
                ...
                <p id="story" class="mt-2 text-gray-700">
                    Pembangunan Masjid Al-Ikhlas di desa terpencil ini menjadi harapan besar bagi masyarakat sekitar. Masjid ini nantinya akan menjadi tempat ibadah, belajar, dan pusat kegiatan sosial bagi ratusan warga yang selama ini harus menempuh perjalanan jauh untuk beribadah. 
                    <span id="dots">...</span><span id="more" class="hidden">Namun, pembangunan ini terhenti karena keterbatasan dana. Dengan bantuan dari para donatur, kami berharap bisa segera menyelesaikan pembangunan ini agar Masjid Al-Ikhlas dapat digunakan untuk kegiatan ibadah dan kemasyarakatan.</span>
                </p>
